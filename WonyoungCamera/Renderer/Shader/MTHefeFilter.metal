...
fragment float4 MTHefeFragment(SingleInputVertexIO vertexIn [[ stage_in ]], 
    ...
    sampler textureSampler [[ sampler(0) ]])
{
    ...
    float3 final = float3(softLight.sample(s, float2(gradSample.r, texel.r)).r,
                      softLight.sample(s, float2(gradSample.g, texel.g)).r,
                      softLight.sample(s, float2(gradSample.b, texel.b)).r);
    ...
    float3 metaled = float3(softLight.sample(s, float2(metal.r, final.r)).r,
                        softLight.sample(s, float2(metal.g, final.g)).r,
                        softLight.sample(s, float2(metal.b, final.b)).r);
