...
fragment float4 MTRiseFragment(SingleInputVertexIO vertexIn [[ stage_in ]], 
    ...
    sampler textureSampler [[ sampler(0) ]])
{
    ...
    texel.g = overlay.sample(s, float2(bbTexel.g, texel.g)).r;
    texel.b = overlay.sample(s, float2(bbTexel.b, texel.b)).r;
