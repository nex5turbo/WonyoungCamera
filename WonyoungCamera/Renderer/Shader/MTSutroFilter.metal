...
fragment float4 MTSutroFragment(SingleInputVertexIO vertexIn [[ stage_in ]], 
    ...
    sampler textureSampler [[ sampler(0) ]])
{
    ...
    lookup.y = texel.g;
    texel.g = vignetteMap.sample(s, lookup).r;
    lookup.y = texel.b;
    texel.b    = vignetteMap.sample(s, lookup).r;
    ...
    texel.g = softLight.sample(s, float2(metal.g, texel.g)).r;
    texel.b = softLight.sample(s, float2(metal.b, texel.b)).r;
