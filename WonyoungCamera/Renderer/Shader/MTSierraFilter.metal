...
fragment float4 MTSierraFragment(SingleInputVertexIO vertexIn [[ stage_in ]], 
    ...
    sampler textureSampler [[ sampler(0) ]])
{
    ...
    color.g = overlay.sample(s, float2(vignetteSample.g, color.g)).r;
    color.b = overlay.sample(s, float2(vignetteSample.b, color.b)).r;
    ...
    color.g = softLight.sample(s, float2(smokeSample.g, color.g)).r;
    color.b = softLight.sample(s, float2(smokeSample.b, color.b)).r;
