...
fragment float4 MTBrannanFragment(SingleInputVertexIO vertexIn [[ stage_in ]], 
    ...
    sampler textureSampler [[ sampler(0) ]])
{
    ...
    lookup.x = texel.g;
    sampled.g = blowout.sample(s, lookup).r;
    lookup.x = texel.b;
    sampled.b = blowout.sample(s, lookup).r;
    ...
    lookup.x = texel.g;
    texel.g = contrast.sample(s, lookup).r;
    lookup.x = texel.b;
    texel.b = contrast.sample(s, lookup).r;
